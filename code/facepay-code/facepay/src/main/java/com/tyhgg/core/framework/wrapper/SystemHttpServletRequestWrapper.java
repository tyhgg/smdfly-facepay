...
public class SystemHttpServletRequestWrapper extends HttpServletRequestWrapper {
	 ...
	 */
	public SystemHttpServletRequestWrapper(HttpServletRequest request)
			throws IOException, ServletException, SystemException {
		super(request);
		
		// 系统配置参数
		int maxsize=Integer.valueOf(SystemCacheHolder.getSystemPropertyCache().getMaps().get("datagram.maxsize"));
