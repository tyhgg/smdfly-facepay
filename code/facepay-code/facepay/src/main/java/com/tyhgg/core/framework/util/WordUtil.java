        ...
        try {  
            ...
            if (param != null && param.size() > 0) {  
              ...
              //  processParagraphs(paragraphList, param, doc);  
                processPointedParagraphs(paragraphList, param, doc);  
 ...
 * @param paragraphList 
 */ 
public static void processPointedParagraphs(List<XWPFParagraph> paragraphList,Map<String, Object> param,XWPFDocument doc){  
    if(paragraphList != null && paragraphList.size() > 0){  
        for(XWPFParagraph paragraph:paragraphList){  
            List<XWPFRun> runs = paragraph.getRuns();  
            for (XWPFRun run : runs) {  
                    ...
                    for (Entry<String, Object> entry : param.entrySet()) {  
                        ...
                        if(text.indexOf(key) != -1){  
                            ...
                            if(value.toString().indexOf("\r") != -1){
                                // isSetText = false;  
                            String[] subContent = value.toString().split("\r");
...
//         XWPFDocument doc = WordUtil.generateWord(param, "D:/test/tttt.docx");    
//         FileOutputStream fopts;
//		try {
//			fopts = new FileOutputStream("d:/test/tttt01.docx");
//			try {
//				doc.write(fopts);
//				fopts.close();    
//			} catch (IOException e) {
